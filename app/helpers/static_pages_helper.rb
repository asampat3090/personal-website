module StaticPagesHelper
  ...
  def load_blog_feed
    feed = feedjira::Feed.fetch_and_parse("http://anandsampat.wordpress.com/feed");
  ...
  def load_reading_feed
    ...
    feedjira::Feed.fetch_and_parse("http://getpocket.com/users/anand.sampat/feed/read").entries.each do |e|
